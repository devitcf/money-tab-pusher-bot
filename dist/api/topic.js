...
exports.getPaidVideo = void 0;
const tokenSession_1 = require("../session/tokenSession");
const auth_1 = require("./auth");
const getPaidVideo = (username_1, topicId_1, ...args_1) => __awaiter(void 0, [username_1, topicId_1, ...args_1], void 0, function* (username, topicId, retry = true) {
    ...
    if (res.status === 401 && retry) {
        if (token === null || token === void 0 ? void 0 : token.refreshToken) {
            ...
            return (0, exports.getPaidVideo)(username, topicId, false);
        }
        throw new Error(res.statusText);
    }
    return res.json();
});
exports.getPaidVideo = getPaidVideo;
